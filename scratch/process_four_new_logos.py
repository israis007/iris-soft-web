...
def clean_and_convert(src_filename, dest_filename, white_threshold=240, tolerance=25):
...
# Map the files based on our identification:
# media__1782181483365.png -> agilethought.webp
# media__1782181483378.png -> factumex.webp
# media__1782181483424.png -> mtp.webp
# media__1782182448223.png -> consubanco.webp

clean_and_convert('media__1782181483365.png', 'agilethought.webp')
clean_and_convert('media__1782181483378.png', 'factumex.webp')
clean_and_convert('media__1782181483424.png', 'mtp.webp')
clean_and_convert('media__1782182448223.png', 'consubanco.webp')
